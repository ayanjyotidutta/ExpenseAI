...
This step establishes the **data layer foundation** for the ExpenseAI application.
...
- Opens connection to `ExpenseAI.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
    - name: Demo User
    - email: [demo@ExpenseAI.com](mailto:demo@ExpenseAI.com)
